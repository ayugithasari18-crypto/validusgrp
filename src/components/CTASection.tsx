...
export const CTASection: React.FC = () => {
  const title = 'Validus Group - Homepage';
  const description = 'Get in touch with our expert team and discover how we can help you achieve your goals.';
  
  const contactInfo = [
    {
      icon: <Mail className="w-6 h-6" />,
      label: 'Email',
      value: 'contact@businesspro.com',
      href: 'mailto:contact@businesspro.com',
    },
    {
